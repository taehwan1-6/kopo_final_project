                ...
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                        <div class="mb-3 mb-lg-0">
                            <h1 class="mb-0 h2 fw-bold">챌린지 개설 </h1>
                            <!-- Breadcrumb -->
                        ...
                        <!-- button -->
                        <div>
                            <a href="${path}/admin/challenges" class="btn btn-primary me-2">
                                챌린지 목록으로
                            </a>
                        </div>
                    </div>
                ...
                <form name="createChallengeForm" action="${path}/admin/challenges" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input type="text" class="form-control" name="challengeName"
                                   placeholder="새롭게 개설할 챌린지명을 입력해주세요." required>
                        </div>
                        <!-- form group -->
                        <div class="mb-3 col-12">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input type="text" class="form-control" name="challengeInfoSummary"
                                   placeholder="챌린지에 대한 요약을 입력해주세요..."></input>
                        </div>
                        <div class="mb-3 col-12">
