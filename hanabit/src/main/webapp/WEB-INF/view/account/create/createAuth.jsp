            ...
            <section class="section" style="padding-top: 0px">
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <!-- 신분증 업로드 -->
                        <form class="idcard-form" method="post" action="${ path }/account/create/auth"
                            ...
                            <div class="text-center">
                                ...
                                <button class="btn btn-soft-primary" name="idcardSubmitBtn" type="submit" style="display:none"> 제출</button>
                            </div>
                        </form>
