...
<!-- START MODAL -->
<div class="modal fade" id="transferFreeModal" tabindex="-1" aria-hidden="true">
                ...
                <div class="auth-content">
                    <div class="w-100">
                        ...
                        <form action="${ path }/hanamoney/transfer" id="transferFormId" class="auth-form" method="post">
                            ...
                            <div class="mb-3">
                                <label for="targetAccountNumInput" class="form-label">보낼 계좌번호</label>
                                <input required type="text" class="form-control" id="targetAccountNumInput"
                                       name="targetAccountNum" placeholder="누구에게 보낼까요?">
                            </div>
                            <div class="mb-3">
                                <label for="bankSelect" class="form-label">보낼 금융기관 선택</label>
                                <select required class="form-select" id="bankSelect" name="targetBankCode">
